...
<head>
    ...
    <link rel="icon" type="png" href="..//Image/logo.jpg" class="rounded-[50%]">
...
<body class="bg-gray-100">
    ...
    <section>
        <div class="flex justify-evenly sm:flex-wrap w-[90%] mx-auto mb-44">
            <div class="lg:w-[25%] sm:w-full sm:mb-10 h-52 mt-5 border border-3 border-slate-600 hover:border-green-500 transition-all hover:rounded-2xl">
                <img src="..//Image/banner/sneakers.jpg" alt="" class="transition-all duration-300 hover:scale-110 ml-4 mt-[-70px] sm:ml-40 lg:ml-[20px]" width="350">
            ...
            <div class="lg:w-[25%] sm:w-full sm:mb-10 h-52 mt-5 border border-3 border-slate-600 hover:border-green-500 transition-all hover:rounded-2xl">
                <img src="..//Image/boots/Favorit2-removebg-preview (1).png" alt="" class="transition-all duration-300 hover:scale-110 ml-4 mt-[-0px] sm:ml-40 lg:ml-[20px]" width="250">
            ...
            <div class="lg:w-[25%] sm:w-full sm:mb-10 h-52 mt-5 border border-3 border-slate-600 hover:border-green-500 transition-all hover:rounded-2xl">
                <img src="..//Image/domino-164_6wVEHfI-unsplash-removebg-preview.png" alt="" class="transition-all duration-300 hover:scale-110 ml-5 mt-[-3px] sm:w-64 sm:ml-36 lg:ml-[30px]">
    ...
    <!-- Fav brand -->
     <section>
         <div class="flex justify-evenly mb-48 mx-20 ">
             <div class="px-5 py-3 transition-all ease-in-out hover:shadow-md hover:scale-105 duration-300 hover:rounded-md" >
    ...
    <!-- Choose our web-->
     <section>
         <div class="flex bg-white w-[80%] h-[80%] mx-auto mb-10 transition-all duration-300 hover:-translate-y-5">
             <div>
    ...
    <footer class="flex sm:flex-wrap md:flex-nowrap">
        <div class="bg-green-500 w-[500px] 2xl:w-full xl:w-full sm:w-full">
            <img src="..//Image/dunx..png" alt="" class="w-50 h-24 rounded-full ml-10 mt-20 bg-white pl-6 pt-6">
